...
<div>
    <p>Nimed kasvavas järjekorras</p>
    <h1>
    <?php
    /*Ülesanne 5 Daniil Tr 01.12.2020*/
$nimed = array('mari', 'kati', 'juhan', 'miku', 'uku', 'Jana', 'Lisa', 'Evelin');
...
<div>
    ...
    <h1>
        <?php
        echo $nimed[0],'<br>', $nimed[1], '<br>', $nimed[2];
        ?>
    </h1>
    <br>
    ...
    <h1>
        <?php
        $nimed = array('mari', 'kati', 'juhan', 'miku', 'uku', 'Jana', 'Lisa', 'Evelin');
        $rand_keys = array_rand($nimed, 2);
        echo $nimed[$rand_keys[0]] . "\n";
        ?>
    ...
    <h1>
        ...
        $vincode = array("1GKS1GKC8FR966658", "1FTEW1C87AK375821", "1G4GF5E30DF760067", "1FTEW1CW9AF114701", "WAUGGAFC8CN433989", "3G5DA03E83S704506", "4JGDA2EB0DA207570",
    ...
    <P>Kas massiviid on ühepikkused:</P>
    <h1>
        <?php
    ...
    <P>Toyota ja audi arv:</P>
    <h1>
        <?php
        $autod = ["Subaru","BMW","Acura","Mercedes-Benz","Lexus","GMC","Volvo","Toyota","Volkswagen","Volkswagen","GMC","Jeep","Saab","Hyundai","Subaru","Mercedes-Benz",
            "Honda","Kia","Mercedes-Benz","Chevrolet","Chevrolet","Porsche","Buick","Dodge","GMC","Dodge","Nissan","Dodge","Jaguar","Ford","Honda","Toyota","Jeep",
            "Kia","Buick","Chevrolet","Subaru","Chevrolet","Chevrolet","Pontiac","Maybach","Chevrolet","Plymouth","Dodge","Nissan","Porsche","Nissan","Mercedes-Benz",
            "Suzuki","Nissan","Ford","Acura","Volkswagen","Lincoln","Mazda","BMW","Mercury","Mitsubishi","Ram","Audi","Kia","Pontiac","Toyota","Acura","Toyota","Toyota",
            "Chevrolet","Oldsmobile","Acura","Pontiac","Lexus","Chevrolet","Cadillac","GMC","Jeep","Audi","Acura","Acura","Honda","Dodge","Hummer","Chevrolet","BMW",
            "Honda","Lincoln","Hummer","Acura","Buick","BMW","Chevrolet","Cadillac","BMW","Pontiac","Audi","Hummer","Suzuki","Mitsubishi","Jeep","Buick","Ford"];
        $vincode = ["1GKS1GKC8FR966658", "1FTEW1C87AK375821", "1G4GF5E30DF760067", "1FTEW1CW9AF114701", "WAUGGAFC8CN433989", "3G5DA03E83S704506", "4JGDA2EB0DA207570",
            "1FTEW1E88AK070552", "SAJWA0F77F8732763", "JHMFA3F21BS660717", "JTHBP5C29C5750730", "WA1LFAFP9DA963060", "3D7TT2CT6BG521976", "WVWN7EE961049",
            "2C3CA5CG3BH341234", "YV4952CFXC162587", "KNALN4D71F5805172", "JN1CV6EK7BM903692", "5FRYD3H84EB186765", "WAUL64B83N441878", "WDDGF4HBXCF845665",
            "WAUKF78E45A133973", "JN1BY0AR2AM022612", "WA1EY74L69D931520", "3GYFNGEYXBS290465", "1D7CW2GK4AS059336", "JN8AZ1FY5EW087447", "WAUBF78E57A343355",
            "SCFFBCCD8AG695133", "WBAWC73548E143482", "3GYFNGE38DS093883", "SCBCP73WC348460", "JN8AE2KPXE9353316", "2C3CDXDT2EH018229", "1G6AH5SX7D0325662",
        ...
        echo "Toyota =".$toyotarv.'<br>';
        echo "Audi =".$audiarv.'<br>';
        ?>
    </h1>
    <br>

    <P>Vinkoodid mis on väiksem kui 17:</P>
    <h1>
        <?php
            foreach ($vincode as $code){
                if (strlen($code) < 17){
                    echo $code.'<br>';
                }
            }
    ...
    <P>Kasutajal on võimalik nime järgi firmasid eemaldada (kuva nimekiri uuesti):</P>
    <h1>
        <?php
        $firmad = array("Kimia","Mynte","Voomm","Twiyo","Layo","Talane","Gigashots","Tagchat","Quaxo","Voonyx","Kwilith","Edgepulse","Eidel","Eadel","Jaloo","Oyope","Jamia");
        $firma = "Gigashots";

        for ($i = 0; $i < count($firmad); $i++){
            if($firmad[$i] == $firma){
                unset($firmad[$i]);
            }
        }
    ...
    <h1>
        <?php
        $words = array("Indonesia","Canada","Kyrgyzstan","Germany","Philippines",
        ...
        echo $longestWordLength.$longestWord;
        ?>

    </h1>
    <br>

    <P>soreeri nimed kasvavas järjekorras:</P>
    <h1>
        <?php

        $chwords = array("瀚聪","月松","雨萌","展博","雪丽","哲恒","慧妍","博裕","宸瑜","奕漳",
            "思宏","伟菘","彦歆","睿杰","尹智","琪煜","惠茜","晓晴","志宸","博豪",
            "璟雯","崇杉","俊誉","军卿","辰华","娅楠","志宸","欣妍","明美");


        sort($chwords);
        foreach($chwords as $chword)
            echo $chword.'<br>';
        ?>
    ...
    <P>Kuva esimene ja viimane nimi:</P>
    <h1>
        <?php
        ...
        echo array_shift($chwords).'<br>';

        echo array_pop($chwords);
    ...
    <P>väljasta täislause ja kuva Bootstrap Alert kastis:</P>
    <h1>
        <?php

        $search_array = array("Feake","Bradwell","Dreger","Bloggett","Lambole","Daish","Lippiett","
        ...
        if (array_search("Feake", $search_array)); {
    ...
    <P>Kuva massiivist kolmas pilt</P>
    <h1>
        <?php

        $pilt = array("devlin-150x150.jpg","freeland-150x150.jpg","peterus-150x150.jpg","devlin-150x150.jpg","gabriel-150x150.jpg","pete-150x150.jpg");
        echo $pilt[2];
        echo '<img src="peterus-150x150.jpg" alt="Italian Trulli">';
